...
#region Variables
        ...
        /// </summary>
        [TestVariable("09378a28-34b4-4cc3-80a1-b07870df6d94")]
        ...
        /// </summary>
        [TestVariable("187a96bf-ab1f-4ed7-8e76-48c4657be376")]
        ...
        /// </summary>
        [TestVariable("c833d149-f5b9-4c87-96f7-e51ef560d416")]
        ...
        /// </summary>
        [TestVariable("7b421c45-98a1-4399-b259-cbd2a59abe59")]
        ...
        /// </summary>
        [TestVariable("5e6c51b4-83fc-440f-95be-a703dd27bc64")]
        ...
        /// </summary>
        [TestVariable("ec9e8ded-bebf-477f-a267-bb7c5146a93b")]
        ...
        /// </summary>
        [TestVariable("590538ce-d77f-4151-8907-9fdbe1ee9aa7")]
        public string DA
        {
            get { return _DA; }
            set { _DA = value; }
        ...
        /// </summary>
        [TestVariable("283c1515-0994-41a5-ba51-e0e82c3a3b81")]
        ...
        /// </summary>
        [TestVariable("665b25b3-ef99-4e53-b092-a415593cb066")]
        public string City
        {
            get { return _City; }
            set { _City = value; }
        ...
        /// </summary>
        [TestVariable("a4fa2a87-9e22-4944-a442-a3b76113c456")]
        ...
        void ITestModule.Run()
        {
            ...
            //Report.Log(ReportLevel.Info, "Keyboard", "Key sequence 'Auto Ins Collision Second (NorthEast)' with focus on 'ApplicationUnderTest.ClaimInformation_Product'.", repo.ApplicationUnderTest.ClaimInformation_ProductInfo, new RecordItemIndex(22));
            //repo.ApplicationUnderTest.ClaimInformation_Product.PressKeys("Auto Ins Collision Second (NorthEast)");
            //Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute TagValue to '630201' on item 'ApplicationUnderTest.ClaimInformation_Product'.", repo.ApplicationUnderTest.ClaimInformation_ProductInfo, new RecordItemIndex(23));
            repo.ApplicationUnderTest.ClaimInformation_Product.Element.SetAttributeValue("TagValue", "630201");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Delay", "Waiting for 3s.", new RecordItemIndex(24));
            Delay.Duration(3000, false);
            
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute TagValue to '$DateOfLoss' on item 'ApplicationUnderTest.ClaimInformation_DateOfLoss'.", repo.ApplicationUnderTest.ClaimInformation_DateOfLossInfo, new RecordItemIndex(25));
            repo.ApplicationUnderTest.ClaimInformation_DateOfLoss.Element.SetAttributeValue("TagValue", DateOfLoss);
            Delay.Milliseconds(0);
            
            try {
                Report.Log(ReportLevel.Info, "Keyboard", "(Optional Action)\r\nKey sequence '{Tab}' with focus on 'ApplicationUnderTest.ClaimInformation_DateOfLoss'.", repo.ApplicationUnderTest.ClaimInformation_DateOfLossInfo, new RecordItemIndex(26));
            ...
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute TagValue to '$Amount' on item 'ApplicationUnderTest.ClaimInformation_AmountofLoss'.", repo.ApplicationUnderTest.ClaimInformation_AmountofLossInfo, new RecordItemIndex(27));
            repo.ApplicationUnderTest.ClaimInformation_AmountofLoss.Element.SetAttributeValue("TagValue", Amount);
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence '{Tab}' with focus on 'ApplicationUnderTest.ClaimInformation_AmountofLoss'.", repo.ApplicationUnderTest.ClaimInformation_AmountofLossInfo, new RecordItemIndex(28));
            repo.ApplicationUnderTest.ClaimInformation_AmountofLoss.PressKeys("{Tab}");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute TagValue to '$StateOfLoss' on item 'ApplicationUnderTest.ClaimInformation_StateOfLoss'.", repo.ApplicationUnderTest.ClaimInformation_StateOfLossInfo, new RecordItemIndex(29));
            ...
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute TagValue to '$DA' on item 'ApplicationUnderTest.ClaimInformation_DeductibleAmount'.", repo.ApplicationUnderTest.ClaimInformation_DeductibleAmountInfo, new RecordItemIndex(32));
            repo.ApplicationUnderTest.ClaimInformation_DeductibleAmount.Element.SetAttributeValue("TagValue", DA);
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute TagValue to '$Street' on item 'ApplicationUnderTest.ClaimInformation_Street'.", repo.ApplicationUnderTest.ClaimInformation_StreetInfo, new RecordItemIndex(33));
            repo.ApplicationUnderTest.ClaimInformation_Street.Element.SetAttributeValue("TagValue", Street);
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute TagValue to '$City' on item 'ApplicationUnderTest.ClaimInformation_City'.", repo.ApplicationUnderTest.ClaimInformation_CityInfo, new RecordItemIndex(34));
            ...
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute TagValue to 'Rear End' on item 'ApplicationUnderTest.ClaimInformation_AccidentType'.", repo.ApplicationUnderTest.ClaimInformation_AccidentTypeInfo, new RecordItemIndex(36));
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'ApplicationUnderTest.ClaimInformation_TotalLoss' at 6;8.", repo.ApplicationUnderTest.ClaimInformation_TotalLossInfo, new RecordItemIndex(38));
            repo.ApplicationUnderTest.ClaimInformation_TotalLoss.Click("6;8");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Wait", "Waiting 30s to exist. Associated repository item: 'ApplicationUnderTest.ClaimInformation_TotalLoss_True'", repo.ApplicationUnderTest.ClaimInformation_TotalLoss_TrueInfo, new ActionTimeout(30000), new RecordItemIndex(39));
            repo.ApplicationUnderTest.ClaimInformation_TotalLoss_TrueInfo.WaitForExists(30000);
            
            Report.Screenshot(ReportLevel.Info, "User", "", repo.ApplicationUnderTest.ClaimInformation_TotalLoss, false, new RecordItemIndex(40));
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence 'Test' with focus on 'ApplicationUnderTest.ClaimInformation_IncidentFacts'.", repo.ApplicationUnderTest.ClaimInformation_IncidentFactsInfo, new RecordItemIndex(41));
            repo.ApplicationUnderTest.ClaimInformation_IncidentFacts.PressKeys("Test");
            Delay.Milliseconds(0);
            
            Report.Screenshot(ReportLevel.Info, "User", "", repo.PegaCaseManagerPortalGoogleChrome.Screenshot_Window, false, new RecordItemIndex(42));
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'ApplicationUnderTest.SubmitButton1' at 41;11.", repo.ApplicationUnderTest.SubmitButton1Info, new RecordItemIndex(43));
